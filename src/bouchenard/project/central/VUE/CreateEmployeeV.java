...
public class CreateEmployeeV extends JFrame {
	...
	/**
	 * Elements to create a new employee
	 */
	...
	/**
	 * Creates a new window for the adding of a new employee
	 * @param controller: Main Application handler
	 */
	public CreateEmployeeV(ControllerC controller) {
	...
	/**
	 * After the creation, verify the information written
	 */
	class ValidateEmployee implements ActionListener {
		public void actionPerformed(ActionEvent e) {		
			...
			{
				int cont = JOptionPane.showConfirmDialog(null, "Add this employee ?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
				...
				if(cont == JOptionPane.OK_OPTION)
				{
					new Thread(new Runnable(){public void run(){
						...
						if(comboBoxDepartment.getSelectedIndex() == 0)
							controller.InsertEmployee(textId.getText(), textFirstName.getText(), textLastName.getText(), comboBoxSex.getSelectedItem().toString(), textMail.getText(), textPhone.getText(), textStreetNumber.getText(), textStreetName.getText(), textTown.getText(), textZipCode.getText(), startHour, endHour, null);
						else
							controller.InsertEmployee(textId.getText(), textFirstName.getText(), textLastName.getText(), comboBoxSex.getSelectedItem().toString(), textMail.getText(), textPhone.getText(), textStreetNumber.getText(), textStreetName.getText(), textTown.getText(), textZipCode.getText(), startHour, endHour, String.valueOf(comboBoxDepartment.getSelectedItem()));
					}}).start();
				}
			}
		}	
